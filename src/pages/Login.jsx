...
function Login() {
  ...
  return (
    <div className="min-h-auto flex justify-center mt-10 p-3 bg-gray-50 rounded-md">
      <form onSubmit={hdlSubmit} className="flex flex-col gap-5 border border-gray-200 p-5 rounded-md">
        ...
        <button type="submit" className="bg-purple-200 p-1 m-1 rounded-2xl font-bold hover:bg-emerald-100">
          Register
        </button>
